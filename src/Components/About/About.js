    ...
    return(
        <div className="about-wrapper show-on-scroll" id='about'>
            <ScrollAnimation animateIn='fadeIn'
                animateOut='fadeOut' offset={50} className="scroll-animation">
            ...
            <div className="row-wrapper">
                    ...
                    <div className='right-row-wrapper'>
                        ...
                        <div className='icons'>
                            ...
                            <a href='https://www.linkedin.com/in/utkarsh-sangwan-056a071b2?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BUn20yTGlSR2DOC8p8ssEqw%3D%3D' target='_Blank' rel="noreferrer"><img className='icon' src={lin} alt=''></img></a>
                        </div>
                    </div>
            </div>
            <a href='https://drive.google.com/file/d/1AjGhp9OcNgV7hci7gVfBL65SeAZqR1bF/view?usp=sharing' target='_Blank' rel="noreferrer"><button className='button-special'>View Resume</button></a>
            </ScrollAnimation>
        </div>
    );
}
